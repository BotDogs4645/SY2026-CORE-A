...
// !! This is unused now but is kept for reference
public class TunerConstants {
  ...
  // NOTE: These gains are in mechanism (wheel) units due to SensorToMechanismRatio.
  // Run SysId to get properly tuned values. KV scaled by gear ratio as a starting point.
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.01).withKI(0).withKD(0).withKS(0.5).withKV(0.654);
  ...
  private static final Distance kWheelRadius = Inches.of(1.84);
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.04931640625);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.026123046875);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.480224609375);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(0.40380859375);
  ...
  */
  ...
  public static class TunerSwerveDrivetrain extends SwerveDrivetrain<TalonFX, TalonFX, CANcoder> {
    ...
    // devices
    //     * themselves. If they need the devices, they can access them through getters in the
    // classes.
    //     *
    //     * @param drivetrainConstants Drivetrain-wide constants for the swerve drive
    //     * @param odometryUpdateFrequency The frequency to run the odometry loop. If unspecified
    // or set
    //     *     to 0 Hz, this is 250 Hz on CAN FD, and 100 Hz on CAN 2.0.
    ...
    //     * @param visionStandardDeviation The standard deviation for vision calculation in the
    // form [x,
